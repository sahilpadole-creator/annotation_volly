      ...
      <div className="landing-container" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem', animation: 'fadeInDown 0.8s ease-out', position: 'relative', zIndex: 10 }}>
          <div style={{ position: 'relative', display: 'inline-block', marginBottom: '1.5rem' }}>
            ...
            <img src={`${import.meta.env.BASE_URL}logo.png?v=8`} alt="Veritas Pro Logo" style={{ width: '130px', height: '130px', position: 'relative', zIndex: 1, filter: 'drop-shadow(0 10px 20px rgba(0,0,0,0.5))', mixBlendMode: 'screen' }} />
          </div>
      ...
      <div className="landing-container" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem', animation: 'fadeInDown 0.8s ease-out' }}>
          <div style={{ position: 'relative', display: 'inline-block', marginBottom: '1.5rem' }}>
            ...
            <img src={`${import.meta.env.BASE_URL}logo.png?v=8`} alt="Veritas Pro Logo" style={{ width: '100px', height: '100px', position: 'relative', zIndex: 1, mixBlendMode: 'screen' }} />
          </div>
    ...
    <div className="app-container">
      ...
      <div className="sidebar" style={{ minWidth: '200px', maxWidth: '250px', overflowY: 'hidden' }}>
        ...
        <div style={{ flexShrink: 0, paddingBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem', paddingLeft: '0.5rem' }}>
          <img src={`${import.meta.env.BASE_URL}logo.png?v=8`} alt="Veritas Pro Logo" style={{ width: '42px', height: '42px', mixBlendMode: 'screen' }} />
          <div>
