      ...
      <div className="landing-container" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem', animation: 'fadeInDown 0.8s ease-out' }}>
          <div style={{ position: 'relative', display: 'inline-block', marginBottom: '1.5rem' }}>
            ...
            <img src={`${import.meta.env.BASE_URL}logo.png?v=3`} alt="Veritas Pro Logo" style={{ width: '64px', height: '64px', position: 'relative', zIndex: 1, borderRadius: '16px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 8px 32px rgba(0,0,0,0.8)' }} />
          </div>
      ...
      <div className="landing-container" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem', animation: 'fadeInDown 0.8s ease-out' }}>
          <div style={{ position: 'relative', display: 'inline-block', marginBottom: '1.5rem' }}>
            ...
            <img src={`${import.meta.env.BASE_URL}logo.png?v=3`} alt="Veritas Pro Logo" style={{ width: '72px', height: '72px', position: 'relative', zIndex: 1, borderRadius: '18px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 10px 40px rgba(0,0,0,0.9)' }} />
          </div>
    ...
    <div className="app-container">
      ...
      <div className="sidebar" style={{ minWidth: '200px', maxWidth: '250px', overflowY: 'hidden' }}>
        ...
        <div style={{ flexShrink: 0, paddingBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem', paddingLeft: '0.5rem' }}>
          <img src={`${import.meta.env.BASE_URL}logo.png?v=3`} alt="Veritas Pro Logo" style={{ width: '38px', height: '38px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 4px 12px rgba(0,0,0,0.4)' }} />
          <div>
